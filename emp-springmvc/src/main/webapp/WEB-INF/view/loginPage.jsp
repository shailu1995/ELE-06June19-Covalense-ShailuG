...
<body style="background:darkgrey">
        ...
        <div class="col-md-4 offset-2 text-black"  style="background:rgb(32, 165, 87)">
        <div class="card-body">
        <h6 class="text-center">came here by jsp page</h6>
        </div>
        </div>
        <div class="col-md-4 offset-2 text-black"  style="background:lightblue">        
            <div class="card-body">
            ${invalide}
                <h4 class="text-center">Employee Managment Protocol</h4>
                <form  action="./submit" method="post">
                    <div class="form-group">
                        <label for="name">Emp Id</label>
                        <input type="text" id="empid" name="id" placeholder="Employee Id" class="form-control">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col">
                              <br>
                                <button type="button" class="form-control btn btn-outline-success" onclick="employeeInfo.jsp" >Create Account</button>
                            </div>
